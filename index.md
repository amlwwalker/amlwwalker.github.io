...
* Dev ops
* Product developer
* Product designer (cyber security, software developer, data science)
* Data analytics content creation
* Business/technology overlap and spec design

- As the company was growing it was necessary to formalise a lot of the technology that was being used to run the business so that the business and its clients could scale efficiently and economically, however my main focus was on the security of the data and products the company offered.
